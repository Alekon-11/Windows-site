...
window.addEventListener('DOMContentLoaded', function (e) {
  ...
  Object(_modules_timer__WEBPACK_IMPORTED_MODULE_3__["default"])('#timer', '2022-11-11');
...
function changeModalState(state) {
  var windowShape = document.querySelectorAll('.balcon_icons_img');
  ...
  function bindActionToElem(elems, event, prop) {
    elems.forEach(function (item, num) {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            throw new Error("Oops, we get error: ".concat(res.status));
  ...
  function sendForm(form) {
    form.addEventListener('submit', function (e) {
      ...
      postData('assets/server.php', formData).then(function (data) {
        return message.textContent = messages.success;
      }).catch(function () {
        return message.textContent = messages.fail;
      }).finally(function () {
        setTimeout(function () {
...
function images() {
  var workArea = document.querySelector('.works');
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var timer = function timer(timerSelector, endtime) {
  ...
  function setClock(timerSelector, endtime) {
    var timer = document.querySelector(timerSelector);
    var day = timer.querySelector('#days');
    var hour = timer.querySelector('#hours');
    var minute = timer.querySelector('#minutes');
    var second = timer.querySelector('#seconds');
    var intId = setInterval(updateClock, 1000);

    function updateClock() {
      var _getTimeRemaining = getTimeRemaining(endtime),
          time = _getTimeRemaining.time,
